...
const Search = () => {
  ...
  return (
    <div className="flex mx:3 w-full items-center bg-gray-100 dark:bg-slate-900 rounded-lg overflow-hidden px-2 py-1.5 justify-between">
      <input onKeyUp={(e)=>handleEnter} value={city} onChange={(e)=>setCity(e.target.value)} className="text-base bg-transparent flex-grow outline-none px-2 " type="text" placeholder="Search your city" />
