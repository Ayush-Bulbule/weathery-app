...
const CurrentCard = () => {
    ...
    const getWeather = async (latitude: number, longitude: number) => {
        ...
        //Link
        const url = (cityName == '') ? `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=e513d046730a4e2a203dd95c606fec56` :
            `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&units=metric&appid=e513d046730a4e2a203dd95c606fec56`;
        ...
        <>
            <div className="main flex p-4 px-20">
                ...
                <div className="text flex flex-col w-1/2 justify-center">
                    ...
                    <h1 className="text-2xl font-bold my-3">{weather ? weather.name : <Skeleton />}</h1>
